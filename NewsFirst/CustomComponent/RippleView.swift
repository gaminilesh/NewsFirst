...
class RippleView: UIView {
    ...
    var onRippleTap: ((UIButton)->Void)? = nil
    ...
    private func getAnimation() -> CAAnimationGroup {
        ...
        scaleAnimation.toValue = NSValue(caTransform3D: CATransform3DMakeScale(CGFloat(5), 2, 1))
